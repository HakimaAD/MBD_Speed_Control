...
## Generated on : Fri Nov 14 01:31:22 2025
...
COMPILER_COMMAND_FILE     = MBD_SpeedControl_comp.rsp
CMD_FILE                  = MBD_SpeedControl.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MBD_SpeedControl.exe
...
DEFINES_STANDARD = -DMODEL=MBD_SpeedControl -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/MBD_SpeedControl_ert_rtw/MBD_SpeedControl.c

MAIN_SRC = $(START_DIR)/MBD_SpeedControl_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MBD_SpeedControl.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/MBD_SpeedControl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/MBD_SpeedControl_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
